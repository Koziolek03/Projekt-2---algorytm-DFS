...
void wybranie_grafu1() {
    ...
    vector<wektory> graf = { w0, w1, w2, w3, w4, w5, w6, w7, w8 };
...
void wybranie_grafu2() {
    ...
    vector<wektory> graf = { w0, w1, w2, w3, w4, w5, w6 };
...
void wybranie_grafu3() {
    ...
    vector<wektory> graf = { w0, w1, w2, w3, w4, w5, w6, w7, w8, w9, w10 };
